...
// class Zainab extends StatelessWidget {
//   const Zainab({super.key});
...
class Zainab extends StatefulWidget {
  const Zainab({super.key});

  @override
  State<Zainab> createState() => _Zscreen();
}

class _Zscreen extends State<Zainab>{
                ...
                Row(
                  ...
                  children: <Widget> [
                    ...
                    SignInButton(
                      ...
                      mini: true,
                      onPressed: () {
                        const link = "https://www.linkedin.com/in/zaineb-makati/";
                        launchUrl(
                          Uri.parse(link),
                          mode: LaunchMode.externalApplication
                        );
